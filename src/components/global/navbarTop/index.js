    ...
    return (
        <div className="flex items-center justify-between border-b h-24 bg-secondary">
            <div className="flex items-center w-fit">
               <svg version="1.0" xmlns="http://www.w3.org/2000/svg" className="ml-4 w-8 h-8" viewBox="0 0 32.000000 32.000000" preserveAspectRatio="xMidYMid meet">
                ...
                <p className="text-4xl font-[Sofia-pro]">Instan<span className="text-tertiary">Trip</span></p>
            </div>
